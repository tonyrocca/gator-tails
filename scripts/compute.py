...
league = {
    ...
    "firstQB": min([p for p in allp if p["pos"] == "QB" and p["pick"]], key=lambda p: p["pick"]),
    "firstK": min([p for p in allp if p["pos"] == "K" and p["pick"]], key=lambda p: p["pick"]),
    "firstTE": min([p for p in allp if p["pos"] == "TE" and p["pick"]], key=lambda p: p["pick"]),
